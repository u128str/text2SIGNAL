...
def check_password():
    ...
    def password_entered():
        ...
        #workspace_name= st.session_state["workspace_id"]
        #username= st.session_state["username"]
        #pw=st.session_state["password"]
        try:
            username= st.session_state["username_signavio"]
            workspace_name=st.session_state["workspace_id"] #st.session_state["workspace_name"]
            ...
            st.session_state["workspacename"]=st.session_state["workspace_id"] #st.session_state["workspace_name"]
            ...
            try: 
               ...
               #st.write(st.session_state["list_of_workspaces"])
               st.session_state["workspace_name"] = [ wrk for wrk in st.session_state["list_of_workspaces"]["data"]["session"]["workspaces"] if wrk["id"] == st.session_state["workspace_id"]][0]
...
if "workspacename" in st.session_state and 'workspaceid' in st.session_state:
    ...
    initial_process=list_processes['data']['subjects'][0]["id"]
    st.text_input("Select Process id where we create LLM-based widgets ",initial_process, key="process_id")
